...
export const ResidentialHero: React.FC = () => {
  ...
  return (
    <>
      <section className="relative pt-24 pb-12 sm:pt-28 sm:pb-16 lg:pt-36 lg:pb-20 bg-[#07172b] text-white flex flex-col justify-between overflow-hidden min-h-[75vh] sm:min-h-[80vh] md:min-h-[85vh] lg:min-h-[90vh]">
        ...
        <Container className="relative z-10 my-auto w-full py-8 sm:py-12">
      ...
      {/* Feature Badges Strip Section positioned below the Hero image */}
      <div className="bg-[#07172b] py-6 sm:py-8 lg:py-10 border-t border-b border-white/10 text-white relative z-20">
